...
% orientation for sine-wave perturbation so that the peaks and troughs
% meet at the angles 0 and 2*pi.  In other words, these angles produce
% a smooth "corkscrew" pattern around the cylinder or sphere with no
% discontinuities.
%
% For a torus, use:
% 
...
%
% Here, a1 gives the angles that produce a continuous sine-wave
